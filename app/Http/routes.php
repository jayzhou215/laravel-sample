...
Route::post('/users/followers/{id}', 'FollowerController@store')->name('followers.store');
Route::delete('/users/followers/{id}', 'FollowerController@destroy')->name('followers.destroy');
